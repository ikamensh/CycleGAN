...
def build_generator_resnet_9blocks(inputgen, name="generator"):
    with tf.variable_scope(name):
        ...
        o_c1 = general_conv2d(pad_input, ngf, kernel_side, kernel_side, 1, 1, 0.02,name="c1")
        o_c2 = general_conv2d(o_c1, ngf*2, stride, stride, 2, 2, 0.02,"SAME","c2")
        o_c3 = general_conv2d(o_c2, ngf*4, stride, stride, 2, 2, 0.02,"SAME","c3")
        ...
        o_c4 = general_deconv2d(o_r9, [batch_size,128,128,ngf*2], ngf*2, stride, stride, 2, 2, 0.02,"SAME","c4")
        o_c5 = general_deconv2d(o_c4, [batch_size,256,256,ngf], ngf, stride, stride, 2, 2, 0.02,"SAME","c5")
